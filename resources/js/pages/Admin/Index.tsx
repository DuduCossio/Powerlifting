  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full bg-surface-dim px-4 py-4 md:px-8 md:py-8">
        ...
        <div className="mt-6">
          {isThirdAttempt ? (
            <section className="rounded border border-outline-variant bg-surface-container-low p-6 text-center text-on-surface-variant">
              <p className="font-body-base text-body-base">
                Este atleta ya está en su 3er intento. No es necesario registrar un peso adicional.
              </p>
            </section>
          ) : (
            <AdminAttemptBar
